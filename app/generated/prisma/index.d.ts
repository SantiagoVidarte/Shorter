...
export namespace Prisma {
  ...
  */
  ...
  export type ShortUrlOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "original" | "short" | "createdAt" | "clicks", ExtArgs["result"]["shortUrl"]>
  ...
  interface ShortUrlFieldRefs {
    ...
    readonly short: FieldRef<"ShortUrl", 'String'>
  ...
  export type ShortUrlWhereInput = {
    ...
    short?: StringFilter<"ShortUrl"> | string
  ...
  export type ShortUrlScalarWhereWithAggregatesInput = {
    ...
    short?: StringWithAggregatesFilter<"ShortUrl"> | string
